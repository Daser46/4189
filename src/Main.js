    ...
    return (
      <Router>
        <Routes>
            ...
            <Route path="dashboard/coursemodule/textmodule" element={<TextModule id={moduleID}/>}/>
            <Route path="dashboard/coursemodule/videomodule" element={<VideoModule id={moduleID}/>}/>
            <Route path="dashboard/coursemodule/quizmodule" element={<QuizModule id={moduleID}/>}/>
        </Routes>
      </Router>
    );
}
